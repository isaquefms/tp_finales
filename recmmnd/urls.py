...
from api.views import cliente_create, cliente_view, cliente_edit, cliente_delete, hotel_view, hotel_create, hotel_edit, hotel_delete, quarto_view, quarto_create, quarto_edit, quarto_delete, recomendacao_view, recomendacao_create, recomendacao_edit, recomendacao_delete
